    ...
    <div className={styles.footer}>
      <div className={styles.firstFooter}>
        ...
        <div className={styles.fPages}>
          <h5>Pages</h5>
          <Link href="http://skillslash.com/event">
            <p>Events</p>
          </Link>
          <Link href="http://skillslash.com/About">
            <p>About</p>
          </Link>
          <Link href="http://skillslash.com/blog">
            <p>Blog</p>
          </Link>
          <Link href="http://skillslash.com/Contact-us">
            <p>Contact</p>
          </Link>
          <h5>Join us</h5>
          <Link href="http://skillslash.com/Career">
            <p>Career</p>
          </Link>
        ...
        <div className={styles.FJoin}>
          ...
          <div className={styles.linksWrap}>
            <Link href="http://skillslash.com/advanced-data-science-and-ai-course-with-real-work-experience">
              <span>Advanced Data Science and AI Course </span>
            </Link>
            <Link href="http://skillslash.com/business-analytics-course">
              <span>Business Analytics online Training </span>
            </Link>
            <Link href="http://skillslash.com/full-stack-developer-course">
              <span>Full Stack Developer course with certification</span>
            </Link>
            <Link href="http://skillslash.com/web-development-course">
              <span>Web Development Course With Certification</span>
            </Link>
          </div>
          <div className={styles.terms}>
            <h5>Terms & condition</h5>
            <Link href="http://skillslash.com/terms-of-use">
              <span>Terms of Use</span>
            </Link>
            <Link href="http://skillslash.com/privacy-statement">
              <span>Privacy Policy</span>
            </Link>
            <Link href="http://skillslash.com/refunds-cancellation">
